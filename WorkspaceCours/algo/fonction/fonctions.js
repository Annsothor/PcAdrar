...
console.log("f1 est spécialisée pour de l'affichage. si je veux afficher la valeur, f1 est plus pratique que f2. par contre, si je veux faire autre chose avec la valeur (enregister dans une vaiable, faire avancer la tortue de (x) px, etc) je ne peux pas en utilisant f1, donc f2 nous donne plus de liberté");
...
// Version utilisant f7
function f8v2(n1,n2,n3){
    if (f7(n1,n2)>=n3){
        return f7(n1,n2);
    }else return n3;
}
//ou encore plus simple:
function f8v3(n1,n2,n3){
    let maxn = f7(n1,n2);
    return f7(maxn,n3);
}
//ou encore plus simple:
